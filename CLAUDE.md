...
- `tsc --noEmit` → **نضيف ✅**
- `php artisan test` → **217/217 ناجحة ✅** (17 ملف Feature — تغطية حقيقية للدومين)
