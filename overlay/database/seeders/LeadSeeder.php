    ...
    public function run(): void
    {
        $rows = [
            [
                ...
                'message' => 'أبحث عن شقة 3 غرف في التجمع الخامس، تسليم فوري إن أمكن.',
                'days' => 0,
            ],
            [
            ...
            [
                ...
                'notes' => 'ميزانيته مؤكدة وجاهز للمعاينة. حجزنا معاينة السبت.',
                'days' => 5,
            ],
            [
                ...
                'message' => 'فيلا في زايد الجديدة — لديّ استعداد للدفع كاش إن وُجد خصم.',
