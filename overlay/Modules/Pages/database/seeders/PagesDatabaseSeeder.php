...
class PagesDatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        if ($drafts > 0) {
            $this->command->warn('  ⚠ المسوّدات تحتاج مراجعة قانونية وملء المواضع الفارغة قبل النشر');
        }
    }
    ...
    private function pages(): array
    {
        return [
            [
                ...
                'excerpt' => 'ما البيانات التي نجمعها منك، وفيمَ نستخدمها، ومن يطّلع عليها.',
                'excerpt_en' => 'What data we collect, what we use it for, and who can see it.',
                'sort' => 10,
                'body' => <<<'TXT'
                    يشرح هذا المستند كيف تتعامل [اسم الشركة] مع البيانات التي تصلها من خلال هذا الموقع.

                    ## البيانات التي نجمعها
                    - **بيانات تقدّمها بنفسك:** الاسم ورقم الهاتف والبريد الإلكتروني عند إرسال طلب أو إنشاء حساب أو إضافة وحدة.
                    - **بيانات تُسجَّل تلقائيًا:** الصفحات التي تفتحها، ووقت الزيارة، ونوع المتصفح، وعنوان الـ IP.
                    - **تفضيلاتك:** عمليات البحث التي تحفظها، والوحدات التي تضيفها إلى المفضلة، والوحدات التي شاهدتها مؤخرًا.

                    ## فيمَ نستخدمها
                    - الرد على طلبك وترشيح وحدات تناسب ميزانيتك والمنطقة التي تبحث فيها.
                    - إرسال تنبيه عند توفّر وحدة تطابق بحثًا حفظته — ويمكنك إيقافه في أي وقت من صفحة «البحث المحفوظ».
                    - تحسين ترتيب النتائج ومعرفة الأقسام التي تُستخدم فعلًا.

                    **لا نبيع بياناتك ولا نؤجّرها لأي طرف ثالث.**

                    ## من يطّلع على بياناتك
                    - فريق العمل لدينا، ولا يطّلع أي فرد إلا على ما يحتاجه عمله.
                    - المطوّر أو صاحب الوحدة التي طلبت التواصل بشأنها — نرسل إليه بيانات تواصلك ليرد عليك.
                    - الجهات الرسمية إذا طُلب منا ذلك بأمر قانوني.

                    ## ملفات تعريف الارتباط (الكوكيز)
                    نستخدم ملفات تعريف الارتباط لإبقاء جلستك مفتوحة وتذكّر لغة العرض التي اخترتها. وإذا استخدمنا أدوات تحليلات، فإن ملفاتها تساعدنا على معرفة الصفحات الأكثر زيارة دون معرفة هويتك الشخصية. ويمكنك تعطيلها من إعدادات متصفحك — غير أن الدخول والتفضيلات لن تبقى محفوظة عندئذٍ.

                    ## مدة الاحتفاظ
                    نحتفظ ببيانات الطلب مدة [حدّد المدة] من آخر تواصل بيننا. أما حساب المستخدم وبياناته فتبقى ما دام الحساب نشطًا.

                    ## حقوقك
                    - أن تطلب نسخة من بياناتك لدينا.
                    - أن تطلب تصحيح أي بيانات خاطئة.
                    - أن تطلب حذف حسابك وبياناته.
                    - أن توقف تنبيهات البحث المحفوظ في أي وقت.

                    للتواصل بشأن أي من هذه الطلبات: [بريد التواصل].

                    ## تعديلات على السياسة
                    عند تعديل أي بند في هذه السياسة يُحدَّث التاريخ أسفل الصفحة. والاستمرار في استخدام الموقع بعد التعديل يعني الموافقة على النسخة الجديدة.
                    TXT,
                'body_en' => <<<'TXT'
            ...
            [
                ...
                'sort' => 20,
                'body' => <<<'TXT'
                    باستخدامك هذا الموقع فإنك توافق على الشروط الواردة أدناه. وإن لم تكن موافقًا على أي بند منها، فالرجاء عدم استخدام الموقع.

                    ## طبيعة الخدمة
                    الموقع منصّة عرض ووساطة عقارية. نعرض وحدات ومشاريع ونوصّلك بصاحبها أو بمطوّرها — **ولسنا طرفًا في أي تعاقد يتم بينك وبينه.**

                    ## دقة البيانات المعروضة
                    نراجع البيانات قبل نشرها، غير أن الأسعار وحالة الوحدات تتغيّر باستمرار، وبعض البيانات تصلنا من المُعلن نفسه. أي أن:
                    - السعر المعروض **مؤشّر** ويجب تأكيده وقت التعاقد.
                    - توافر الوحدة غير مضمون حتى تتأكد منّا.
                    - الصور والمساحات والتشطيب تصف الوحدة النموذجية وقد تختلف عن الوحدة الفعلية.

                    **راجع كل بيان بنفسك قبل دفع أي مبلغ.**

                    ## حسابك
                    - أنت مسؤول عن سرية كلمة مرورك وعن أي نشاط يصدر من حسابك.
                    - يجب أن تكون البيانات التي تدخلها صحيحة وخاصة بك.
                    - يحق لنا إيقاف أي حساب يخالف هذه الشروط.

                    ## عند إضافة وحدة
                    - يجب أن تكون مالك الوحدة أو مفوّضًا من المالك بعرضها.
                    - يجب أن تكون البيانات والصور التي ترفعها ملكك أو لديك حق استخدامها.
                    - تُراجع كل وحدة قبل النشر، وأي تعديل بعد النشر يعيدها للمراجعة.
                    - يحق لنا رفض أو إيقاف أي وحدة بياناتها ناقصة أو مضلّلة.

                    ## الاستخدام الممنوع
                    - نسخ محتوى الموقع أو سحبه آليًا لإعادة نشره.
                    - إرسال بيانات غير صحيحة أو انتحال صفة غيرك.
                    - أي محاولة للوصول إلى أجزاء من النظام غير مصرّح لك بها.

                    ## الملكية الفكرية
                    تصميم الموقع ونصوصه وشعاره ملك لـ [اسم الشركة]. وصور الوحدات ملك لأصحابها أو للمطوّرين، ومعروضة بغرض التسويق.

                    ## حدود المسؤولية
                    مسؤوليتنا محصورة في تشغيل المنصّة وعرض البيانات. ولا نتحمّل أي خسارة ناتجة عن تعاقد بينك وبين طرف ثالث، ولا عن انقطاع مؤقت في الخدمة.

                    ## القانون الواجب التطبيق
                    تخضع هذه الشروط للقانون المصري، وأي نزاع يُحال إلى المحاكم المختصة في [المدينة].

                    ## تعديل الشروط
                    يجوز لنا تعديل هذه الشروط، والتاريخ أسفل الصفحة يوضّح آخر تحديث.
                    TXT,
                'body_en' => <<<'TXT'
