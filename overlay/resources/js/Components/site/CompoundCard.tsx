...
export default function CompoundCard({ c, ar }: { c: Compound; ar: boolean; wa?: string }) {
    ...
    const href = c.slug ? `/${locale}/compounds/${c.slug}` : `/${locale}/compounds`;
        ...
        <article className="group flex h-full flex-col overflow-hidden rounded-2xl border border-gray-100 bg-bg transition duration-200 hover:-translate-y-1 hover:border-primary/50 hover:shadow-[0_12px_30px_rgba(11,18,32,0.07)]">
            <Link href={href} className="flex flex-1 flex-col">
                ...
                <div className="flex flex-1 flex-col gap-2 p-4">
                    ...
                    <span className="mt-auto flex items-center justify-center gap-2 rounded-brand border-2 border-primary py-3 text-center text-[13px] font-extrabold text-secondary transition group-hover:bg-primary group-hover:text-primary-fg">
