...
const copy = {
    ar: {
        ...
        noProjects: "مفيش مشاريع معروضة في المنطقة دي دلوقتي.",
        unitsTitle: "وحدات في المنطقة",
        noUnits: "مفيش وحدات معروضة في المنطقة دي دلوقتي.",
        allUnits: "شوف كل الوحدات",
        formTitle: "دوّرلي على وحدة في المنطقة دي",
        formNote: "قوللنا الميزانية ونوع الوحدة، وهنرجعلك باللي متاح فعلًا.",
    },
    en: {
        crumb: "Areas",
        back: "All areas",
