...
const copy = {
    ar: {
        crumb: "أضف عقارك",
        title: "أضف عقارك",
        desc: "اعرض وحدتك مجانًا. نراجع البيانات وننشرها بكود مرجعي، وتصلك طلبات المشترين مباشرة.",
        steps: [
            "املأ بيانات الوحدة وارفع صورها",
            "فريقنا يراجع البيانات خلال ٢٤ ساعة",
            "يُنشر الإعلان بكود مرجعي وتصلك الطلبات",
        ],
        contact: "بيانات التواصل",
        name: "الاسم",
        phone: "رقم الهاتف",
        email: "البريد الإلكتروني",
        submit: "أرسل العقار للمراجعة",
        sending: "جارٍ الإرسال…",
        doneTitle: "وصلنا عقارك ✅",
        doneText: "يراجع الفريق البيانات وينشر الإعلان خلال ٢٤ ساعة. سنتواصل معك إذا احتجنا أي توضيح.",
        another: "أضف عقارًا آخر",
        note: "لا يظهر الإعلان على الموقع قبل المراجعة — وهذا يحمي الباحثين من الإعلانات الوهمية.",
        required: "الحقول المطلوبة عليها *",
        mineGuest: "أرسلنا إلى بريدك رابطًا لتفعيل حسابك ومتابعة وحدتك منه.",
