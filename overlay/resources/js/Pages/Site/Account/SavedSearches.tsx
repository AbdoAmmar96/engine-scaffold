...
const copy = {
    ar: {
        title: "البحث المحفوظ",
        empty: "لسه مفيش بحث محفوظ",
        emptyText: "فلتر العقارات زي ما إنت عايز، وبعدها اضغط «احفظ البحث ده» — وهنبعتلك أول ما ينزل اللي يطابقه.",
        browse: "روح افلتر",
        matches: (n: number) => (n === 1 ? "وحدة مطابقة دلوقتي" : `${n} وحدة مطابقة دلوقتي`),
        open: "افتح النتايج",
        alertsOn: "التنبيه شغّال",
        alertsOff: "التنبيه متوقّف",
        rename: "غيّر الاسم",
        save: "احفظ",
        cancel: "إلغاء",
        remove: "حذف",
        confirm: "تمسح البحث ده؟",
        last: "آخر تنبيه:",
    },
    en: {
