...
const copy = {
    ar: {
        title: "قيّم تجربتك",
        intro: "يُنشر رأيك على الموقع باسمك بعد مراجعته. رأي واحد لكل حساب — يمكنك تعديله في أي وقت.",
        rating: "تقييمك",
        compound: "عن أي مشروع؟ (اختياري)",
        compoundAny: "الخدمة عمومًا",
        body: "رأيك",
        bodyHint: "٢٠ حرفًا على الأقل — اكتب ما حدث معك فعلًا، فهذا ما يفيد من يقرأ.",
        save: "أرسل رأيك",
        update: "حدّث رأيك",
        statusPending: "رأيك تحت المراجعة — يُنشر على الموقع بعد اعتماده.",
        statusPublished: "رأيك منشور على الموقع ✅",
        statusRejected: "لم يُنشر رأيك. يمكنك تعديله وإعادة إرساله.",
        note: "أي تعديل يُعيد الرأي للمراجعة مرة أخرى.",
    },
    en: {
