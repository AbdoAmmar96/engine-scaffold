...
const copy = {
    ar: {
        title: "وحداتي",
        add: "أضف وحدة",
        empty: "لم تُضِف أي وحدة بعد",
        emptyText: "ابدأ بوحدة واحدة — نراجعها وتُنشر بكود مرجعي، ثم تتابع مشاهداتها وطلباتها من هنا.",
        total: "وحدة",
        published: "منشورة",
        ...
        confirm: "هل تريد حذف هذه الوحدة نهائيًا؟",
        stats: { views: "مشاهدات", saves: "محفوظة", requests: "طلبات" },
        rejected: "سبب الرفض:",
        promote: "ترقية الإعلان",
        promoteHint: "اطلب مساحة مميّزة وسيعود إليك الفريق بالسعر والمدة",
    },
    en: {
        title: "My listings",
        add: "Add a listing",
