...
**لسه مفتوح:** مفيش CI (`.github/` لسه مش موجود) ·
باقي المحتوى تجريبي (١٣ وحدة و٦ مقالات) و`contact.whatsapp` فاضي · صفحتا الخصوصية
والشروط مسوّدات محتاجة مراجعة قانونية · `AdminLayout` مش responsive (سايدبار `ps-64`
ثابت — كل صفحات اللوحة بتطفح أفقيًا تحت 1024px).
