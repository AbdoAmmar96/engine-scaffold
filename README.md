...
└── tests/
    ├── Feature/                           15 ملف · 197 اختبار
    └── e2e/smoke.spec.ts                  Playwright — ديسكتوب وموبايل
```

**الأرقام:** 11 موديول · 120 راوت · 29 جدول · 62 ملف TSX · 12 صلاحية · 10 أدوار.
...
`php artisan test` → **197/197 ✅** · `playwright` → **95 ✅ (+1 متخطّى عن قصد)** · `tsc --noEmit` → **نضيف ✅**
